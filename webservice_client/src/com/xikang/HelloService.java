 ...
 * 
 */
@WebServiceClient(name = "helloService", targetNamespace = "http://xikang.com/", wsdlLocation = "http://localhost:8088/ws_server/worda?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://xikang.com/", "helloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8088/ws_server/worda?wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://xikang.com/", "helloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://xikang.com/", "helloPort"), Hello.class, features);
    }
